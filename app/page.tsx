    ...
    <div className="flex h-screen items-center justify-center font-sans dark:bg-black">
      <main className="w-full h-screen overflow-hidden relative">
        ...
        <div className="overflow-y-auto px-5 pt-[100px] pb-[130px]">
          <div className="flex flex-col items-center justify-start w-full max-w-3xl mx-auto gap-6">
            {isClient ? (
              <>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-linear-to-t from-background via-background/50 to-transparent dark:bg-black overflow-visible pt-5">
